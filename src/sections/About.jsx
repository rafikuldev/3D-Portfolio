...
//           />
//           <div className="z-10">
//             <p className="headtext">Hi, I'm Rafikul islam</p>
//             <p className="subtext">
      ...
      <div className="grid grid-cols-1 gap-4 mt-12 md:grid-cols-6 md:auto-rows-[18rem]">
        ...
        <div className="relative grid-default-color grid-2">
          ...
          >
            ...
            <Card style={{ rotate: "-30deg", top: "60%", left: "45%" }} text="PHP" containerRef={grid2Container} />
            <Card style={{ rotate: "90deg", bottom: "30%", left: "70%" }} text="Laravel" containerRef={grid2Container} />
            <Card style={{ rotate: "-45deg", top: "55%", left: "0%" }} text="JavaScript" containerRef={grid2Container} />
            <Card style={{ rotate: "20deg", top: "10%", left: "38%" }} text="React" containerRef={grid2Container} />

            <Card style={{ rotate: "30deg", top: "70%", left: "70%" }} image="assets/logos/laravel.png" containerRef={grid2Container} />
            <Card style={{ rotate: "-45deg", top: "70%", left: "25%" }} image="assets/logos/php.png" containerRef={grid2Container} />
